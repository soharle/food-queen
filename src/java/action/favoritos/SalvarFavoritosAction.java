 ...
 * @author mathe
 */
public class SalvarFavoritosAction implements Action {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            Favoritos favoritos = new Favoritos(consumidor, loja);
            FavoritosDAO.getInstance().save(favoritos);
            response.sendRedirect("sucesso.jsp");
        } catch (IOException | SQLException | ClassNotFoundException ex) {
            Logger.getLogger(SalvarFavoritosAction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
